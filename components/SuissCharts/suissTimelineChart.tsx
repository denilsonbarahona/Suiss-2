...
export default function SuissTimeLineChart({ title }: { title: string }) {
  const chartData = {
    labels: [
      '12-01-2020',
      '01-01-2021',
  ...
  return (
    <div className='flex flex-col col-span-full xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-3xl border border-slate-200 dark:border-slate-700'>
